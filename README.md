...
northWall[R+1][C]  # True = wall exists ABOVE cell (row, col)
eastWall[R][C+1]   # True = wall exists RIGHT of cell (row, col)
...
Controls
•	Adjustable animation speed(page up and page down key)
•	Restart the maze(R key)
